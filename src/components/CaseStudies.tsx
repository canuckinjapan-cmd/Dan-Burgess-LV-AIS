...
const cases: CaseStudy[] = [
  {
    ...
    sector: "Fitness · Local Booking",
    sectorJp: "フィットネス・予約システム",
    summary:
    ...
    summaryJp: "Instagramのみの運用だった高崎のプライベートジムを、コンバージョン重視のランディングページへ再構築。日欧バイリンガル予約システム、タイポグラフィを活かしたエディトリアルデザイン、そして地域層に最適化した体験レッスンまでの導線設計を行いました。",
    ...
    image: "https://danburgess.com/2026-assets/Taka-PCbig-E.jpg",
    jpImage: "https://danburgess.com/2026-assets/Taka-PCbig-J.jpg",
    mobileImage: "https://danburgess.com/2026-assets/Taka-phone-E.jpeg",
    jpMobileImage: "https://danburgess.com/2026-assets/Taka-phone-J.jpeg",
    tabletImage: "https://danburgess.com/2026-assets/Taka-tablet-E.jpeg",
    jpTabletImage: "https://danburgess.com/2026-assets/Taka-tablet-J.jpeg",
    accent: true,
    link: "https://danburgess.com/samples/gym01/index-e.html",
    jpLink: "https://danburgess.com/samples/gym01/index.html",
  },
  {
    id: "lumina",
    index: "02",
    ...
    sector: "Real Estate · Property DB",
    sectorJp: "不動産・物件データベース",
    summary:
    ...
    summaryJp: "膨大な物件データを、洗練されたエディトリアル形式のプラットフォームへ昇華。ダイナミックなタイポグラフィと高度な検索機能を備え、日本人と海外投資家双方の視認性を考慮した情報の重み付けとコンテンツモデルを実現しました。",
    ...
    image: "https://danburgess.com/2026-assets/Real01-PCbig-E.jpg",
    jpImage: "https://danburgess.com/2026-assets/Real01-PCbig-J.jpg",
    mobileImage: "https://danburgess.com/2026-assets/Real01-phone-E.jpg",
    jpMobileImage: "https://danburgess.com/2026-assets/Real01-phone-J.jpg",
    tabletImage: "https://danburgess.com/2026-assets/Real01-tablet-E.jpeg",
    jpTabletImage: "https://danburgess.com/2026-assets/Real01-tablet-J.jpeg",
    link: "https://danburgess.com/samples/real-estate01/index-e.html",
    jpLink: "https://danburgess.com/samples/real-estate01/index.html?lang=ja",
  },
  {
    id: "apex",
    index: "03",
    ...
    sectorJp: "自動車・ECサイト",
    summary:
      "A bilingual storefront connecting overseas enthusiasts to Japan's domestic auction market. Complex logistics, customs and bidding flows compressed into a calm, confidence-building purchase experience.",
    summaryJp: "海外のJDMファンと日本の国内オークション市場を繋ぐバイリンガルECサイト。複雑な物流、通関、入札フローを整理し、ユーザーが安心して購入できるシンプルかつ信頼感のある購入体験を構築しました。",
    ...
    image: "https://danburgess.com/2026-assets/MacBook-Pro-indexbig.jpg",
    mobileImage: "https://danburgess.com/2026-assets/iPhone-16-index.jpg",
    tabletImage: "https://danburgess.com/2026-assets/iPad-index.jpg",
